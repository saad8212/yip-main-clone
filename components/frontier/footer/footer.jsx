  ...
  return (
    <div className={styles.main_div}>
      ...
      <div className={styles.desclaimer}>
        ...
        <p>
          {" "}
          This is NOT an official website of Frontier but is the Official
          ...
          are protected under applicable copyright laws. Frontier does not
        ...
        <div className={styles.second_row}>
          <p>
            {" "}
            [1] For Frontier internet customers new to YouTube TV. This YouTube
            TV discount is only open to participants in the United States who
            have activated the offer from Frontier on or after October 1.
            ...
            participated in a YouTube TV trial before. If eligible: Frontier
            ...
            price; or Frontier Internet with current Frontier TV or Fiber TV
            ...
            redemption of YouTube TV discount per eligible Frontier account.
            Eligible participants must use the activation link provided by
            Frontier and complete activation through Google to claim offer.
            ...
            extra. Frontier Internet account required. Offer and billing subject
            to Frontier Terms and Conditions. Frontier reserves the right to
          ...
          <p>
            [3] Based on comparison of Frontier Fiber 5 Gig upload speed up to
